package com.mowmaster.projectcookbook.block;
...
public class BaseFoodBlock extends Block {
    public BaseFoodBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (world.isClient) {
            if (BaseFoodBlock.tryEat(world, pos, state, player).isAccepted()) {
                return ActionResult.SUCCESS;
            }
        ...
        return BaseFoodBlock.tryEat(world, pos, state, player);
    }
    ...
    public int getComparatorOutput(BlockState state, World world, BlockPos pos) {
        return BaseFoodBlock.getComparatorOutput(state.get(BITES));
    }
